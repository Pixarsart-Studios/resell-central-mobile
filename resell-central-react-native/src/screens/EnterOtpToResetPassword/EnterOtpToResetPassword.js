...
const EnterOtpToResetPassword = ({ navigation }) => {
      ...
      <View style={styles.childContainer}>
        ...
        <View style={styles.descContainer}>
          <Text style={styles.descText}>
            Enter 4 digit code sent to your email address to verify your
            identity.
          </Text>
        </View>
        ...
        <View style={styles.notAccountContainer}>
          ...
          <Text style={styles.signUpText}>loremipsum@gmail.com</Text>
        </View>
...
export default EnterOtpToResetPassword;
