...
export const ManageReturnsData = [
  {
    ...
    status: "Resolved",
    loreamIpsum:
      "Lorem ipsum dolor sit amet consectetur. In sem viverra nulla at sit gravida volutpat tristique lobortis. Amet nibh faucibus in feugiat nunc bibendum posuere turpis a.",
    blueShowsImage: require("./src/Assets/Images/blueShowsImage.png"),
    greenShowsImage: require("./src/Assets/Images/greenShowsImage.png"),
    greyShowsImage: require("./src/Assets/Images/greyShowsImage.png"),
    moreImageBackground: require("./src/Assets/Images/moreImageBackground.png"),
    threePlusImage: require("./src/Assets/Images/3+.png"),
    moreImage: require("./src/Assets/Images/more.png"),
  },
  {
    code: "#6626531546",
    name: "Apple Juiced",
...
export const createProductData = [
  {
    id: 1,
    baseBallImage1: require("./src/Assets/Images/baseBallImage1.png"),
    baseBallImage2: require("./src/Assets/Images/baseBallImage2.png"),
    category: "BaseBall",
    q: "A",
    year: "1994",
